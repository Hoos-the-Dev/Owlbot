...
class Changelogs(commands.Cog):
  ...
  async def changelogs(self, ctx):
    ...
    embed = discord.Embed(title="Changelogs v0.1.0 :newspaper:", description='The first edition of changelogs. Changes have been pushed to the bot, here we go!')
    ...
    embed.add_field(name="Backend Stuff", value="Reworked the backend to support cogs!", inline=True)
